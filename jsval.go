...
// Package validator implements an input validator, based on JSON Schema.
// The main purpose is to validate JSON Schemas (see
// https://github.com/go-json-schema/schema), and to automatically
// generate validators from schemas, but validator can be used independently
// of JSON Schema.
package validator
